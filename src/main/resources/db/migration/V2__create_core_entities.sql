...
CREATE INDEX idx_campaigns_brand_profile_id ON campaigns (brand_profile_id);
CREATE INDEX idx_campaigns_status ON campaigns (status);
CREATE INDEX idx_campaign_applications_campaign_id ON campaign_applications (campaign_id);
CREATE INDEX idx_campaign_applications_creator_profile_id ON campaign_applications (creator_profile_id);
